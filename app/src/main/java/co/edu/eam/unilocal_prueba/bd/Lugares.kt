...
object Lugares {
    ...
    init {
        ...
        val lugar2 = Lugar(2, "Bar City Pub", "Bar en la ciudad de Armenia", 2, true, 5, 73.3534f, -41.4345f, 1)
        ...
        val lugar4 = Lugar(4, "BBC Norte", "Cervezas BBC muy buenas", 1, true, 5, 73.3434f, -40.4345f, 3)
        lugar4.horarios.add(horario3)

        val lugar5 = Lugar(5, "Hotel Barato", "Hotel para ahorrar mucho dinero", 1, true, 1, 73.3434f, -40.4345f, 4)
        lugar5.horarios.add(horario1)

        val lugar6 = Lugar(1, "Hostal Hippie", "Alojamiento para todos y todas", 2, false, 1, 73.3434f, -40.4345f, 2)
